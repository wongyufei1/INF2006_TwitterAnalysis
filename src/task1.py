...
def select_columns(dataframe):
    selected_columns = ["_channel", "_trust", "_country", "airline", "airline_sentiment", "text", "airline_sentiment_gold", "negativereason"]
...
def run():
    ...
    cleaned_tweets.coalesce(1).write.csv(path="../results/task1", mode="overwrite")
